...
public class ThemeListViewPreference extends Preference 
{
	...
	public ThemeListViewPreference(Context context, AttributeSet attrs) 
	{
		super(context, attrs);
		initPreference(context, attrs);
	}

	public ThemeListViewPreference(Context context, AttributeSet attrs, int defStyle) 
	{
